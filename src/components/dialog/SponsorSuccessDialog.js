...
export default function SponsorSuccessDialog({ isOpenDialog, handleOpenDialog }) {
      ...
      >
        <Stack gap="24px" justifyContent="center" alignContent="center">
          <Box sx={{ display: 'flex', gap: '8px', flexDirection: 'column' }}>
            ...
            >
              Maria Franci sponsorship is activated successfully!
            </Typography>
          </Box>
          <Box
            sx={{
...
SponsorSuccessDialog.propTypes = {
